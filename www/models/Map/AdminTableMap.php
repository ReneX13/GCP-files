...
class AdminTableMap extends TableMap
{
     ...
     */
    const COL_PASSWORD_HASH = 'Admin.password_hash';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID, AdminTableMap::COL_USERNAME, AdminTableMap::COL_PASSWORD_HASH, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID => 0, AdminTableMap::COL_USERNAME => 1, AdminTableMap::COL_PASSWORD_HASH => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AdminTableMap::COL_PASSWORD_HASH);
        } else {
