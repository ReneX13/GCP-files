...
class ProductsTableMap extends TableMap
{
    ...
    /**
     * the column name for the rated field
     */
    const COL_RATED = 'Products.rated';
     ...
     */
    const COL_INVENTORY = 'Products.inventory';
    ...
    /**
     * the column name for the ImgFile field
     */
    const COL_IMGFILE = 'Products.ImgFile';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Rated', 'Price', 'Inventory', 'Description', 'Imgfile', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'rated', 'price', 'inventory', 'description', 'imgfile', ),
        self::TYPE_COLNAME       => array(ProductsTableMap::COL_ID, ProductsTableMap::COL_NAME, ProductsTableMap::COL_RATED, ProductsTableMap::COL_PRICE, ProductsTableMap::COL_INVENTORY, ProductsTableMap::COL_DESCRIPTION, ProductsTableMap::COL_IMGFILE, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'rated', 'price', 'inventory', 'description', 'ImgFile', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Rated' => 2, 'Price' => 3, 'Inventory' => 4, 'Description' => 5, 'Imgfile' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'rated' => 2, 'price' => 3, 'inventory' => 4, 'description' => 5, 'imgfile' => 6, ),
        self::TYPE_COLNAME       => array(ProductsTableMap::COL_ID => 0, ProductsTableMap::COL_NAME => 1, ProductsTableMap::COL_RATED => 2, ProductsTableMap::COL_PRICE => 3, ProductsTableMap::COL_INVENTORY => 4, ProductsTableMap::COL_DESCRIPTION => 5, ProductsTableMap::COL_IMGFILE => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'rated' => 2, 'price' => 3, 'inventory' => 4, 'description' => 5, 'ImgFile' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('rated', 'Rated', 'VARCHAR', true, 3, null);
        $this->addColumn('price', 'Price', 'FLOAT', true, 12, null);
        $this->addColumn('inventory', 'Inventory', 'INTEGER', true, 12, null);
        $this->addColumn('description', 'Description', 'LONGVARCHAR', true, null, null);
        $this->addColumn('ImgFile', 'Imgfile', 'VARCHAR', false, 64, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductsTableMap::COL_RATED);
            $criteria->addSelectColumn(ProductsTableMap::COL_PRICE);
            $criteria->addSelectColumn(ProductsTableMap::COL_INVENTORY);
            $criteria->addSelectColumn(ProductsTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(ProductsTableMap::COL_IMGFILE);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.rated');
            $criteria->addSelectColumn($alias . '.price');
            $criteria->addSelectColumn($alias . '.inventory');
            $criteria->addSelectColumn($alias . '.description');
            $criteria->addSelectColumn($alias . '.ImgFile');
        }
    }
