...
class UsersTableMap extends TableMap
{
     ...
     */
    const COL_PAYPAL_EMAIL = 'Users.paypal_email';

    /**
     * the column name for the join_date field
     */
    const COL_JOIN_DATE = 'Users.join_date';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'FirstName', 'LastName', 'Email', 'PasswordHash', 'PaypalEmail', 'JoinDate', ),
        self::TYPE_CAMELNAME     => array('id', 'firstName', 'lastName', 'email', 'passwordHash', 'paypalEmail', 'joinDate', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_FIRST_NAME, UsersTableMap::COL_LAST_NAME, UsersTableMap::COL_EMAIL, UsersTableMap::COL_PASSWORD_HASH, UsersTableMap::COL_PAYPAL_EMAIL, UsersTableMap::COL_JOIN_DATE, ),
        self::TYPE_FIELDNAME     => array('id', 'first_name', 'last_name', 'email', 'password_hash', 'paypal_email', 'join_date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'Email' => 3, 'PasswordHash' => 4, 'PaypalEmail' => 5, 'JoinDate' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firstName' => 1, 'lastName' => 2, 'email' => 3, 'passwordHash' => 4, 'paypalEmail' => 5, 'joinDate' => 6, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_FIRST_NAME => 1, UsersTableMap::COL_LAST_NAME => 2, UsersTableMap::COL_EMAIL => 3, UsersTableMap::COL_PASSWORD_HASH => 4, UsersTableMap::COL_PAYPAL_EMAIL => 5, UsersTableMap::COL_JOIN_DATE => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'first_name' => 1, 'last_name' => 2, 'email' => 3, 'password_hash' => 4, 'paypal_email' => 5, 'join_date' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('first_name', 'FirstName', 'VARCHAR', true, 64, null);
        $this->addColumn('last_name', 'LastName', 'VARCHAR', true, 64, null);
        $this->addColumn('email', 'Email', 'VARCHAR', true, 64, null);
        $this->addColumn('password_hash', 'PasswordHash', 'VARCHAR', true, 128, null);
        $this->addColumn('paypal_email', 'PaypalEmail', 'VARCHAR', true, 64, null);
        $this->addColumn('join_date', 'JoinDate', 'TIMESTAMP', true, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Mailingaddress', '\\Mailingaddress', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), null, null, 'Mailingaddresses', false);
        $this->addRelation('Transactions', '\\Transactions', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_PAYPAL_EMAIL);
            $criteria->addSelectColumn(UsersTableMap::COL_JOIN_DATE);
        } else {
