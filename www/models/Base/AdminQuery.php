 ...
 * @method     ChildAdminQuery orderByPasswordHash($order = Criteria::ASC) Order by the password_hash column
 *
 ...
 * @method     ChildAdminQuery groupByPasswordHash() Group by the password_hash column
 *
 ...
 * @method     ChildAdmin findOneByPasswordHash(string $password_hash) Return the first ChildAdmin filtered by the password_hash column *
 ...
 * @method     ChildAdmin requireOneByPasswordHash(string $password_hash) Return the first ChildAdmin filtered by the password_hash column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildAdmin[]|ObjectCollection findByPasswordHash(string $password_hash) Return ChildAdmin objects filtered by the password_hash column
...
abstract class AdminQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, username, password_hash FROM Admin WHERE id = :p0';
        try {
    ...
    public function filterByPasswordHash($passwordHash = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AdminTableMap::COL_PASSWORD_HASH, $passwordHash, $comparison);
    }
