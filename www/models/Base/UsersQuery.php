 ...
 * @method     ChildUsersQuery orderByPaypalEmail($order = Criteria::ASC) Order by the paypal_email column
 * @method     ChildUsersQuery orderByJoinDate($order = Criteria::ASC) Order by the join_date column
 *
 ...
 * @method     ChildUsersQuery groupByPaypalEmail() Group by the paypal_email column
 * @method     ChildUsersQuery groupByJoinDate() Group by the join_date column
 *
 ...
 *
 * @method     ChildUsersQuery leftJoinCart($relationAlias = null) Adds a LEFT JOIN clause to the query using the Cart relation
 * @method     ChildUsersQuery rightJoinCart($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Cart relation
 * @method     ChildUsersQuery innerJoinCart($relationAlias = null) Adds a INNER JOIN clause to the query using the Cart relation
 *
 * @method     ChildUsersQuery joinWithCart($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Cart relation
 *
 * @method     ChildUsersQuery leftJoinWithCart() Adds a LEFT JOIN clause and with to the query using the Cart relation
 * @method     ChildUsersQuery rightJoinWithCart() Adds a RIGHT JOIN clause and with to the query using the Cart relation
 * @method     ChildUsersQuery innerJoinWithCart() Adds a INNER JOIN clause and with to the query using the Cart relation
 *
 * @method     ChildUsersQuery leftJoinMailingaddress($relationAlias = null) Adds a LEFT JOIN clause to the query using the Mailingaddress relation
 * @method     ChildUsersQuery rightJoinMailingaddress($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Mailingaddress relation
 * @method     ChildUsersQuery innerJoinMailingaddress($relationAlias = null) Adds a INNER JOIN clause to the query using the Mailingaddress relation
 *
 * @method     ChildUsersQuery joinWithMailingaddress($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Mailingaddress relation
 *
 * @method     ChildUsersQuery leftJoinWithMailingaddress() Adds a LEFT JOIN clause and with to the query using the Mailingaddress relation
 * @method     ChildUsersQuery rightJoinWithMailingaddress() Adds a RIGHT JOIN clause and with to the query using the Mailingaddress relation
 * @method     ChildUsersQuery innerJoinWithMailingaddress() Adds a INNER JOIN clause and with to the query using the Mailingaddress relation
 *
 * @method     ChildUsersQuery leftJoinTransactions($relationAlias = null) Adds a LEFT JOIN clause to the query using the Transactions relation
 * @method     ChildUsersQuery rightJoinTransactions($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Transactions relation
 * @method     ChildUsersQuery innerJoinTransactions($relationAlias = null) Adds a INNER JOIN clause to the query using the Transactions relation
 *
 * @method     ChildUsersQuery joinWithTransactions($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Transactions relation
 *
 * @method     ChildUsersQuery leftJoinWithTransactions() Adds a LEFT JOIN clause and with to the query using the Transactions relation
 * @method     ChildUsersQuery rightJoinWithTransactions() Adds a RIGHT JOIN clause and with to the query using the Transactions relation
 * @method     ChildUsersQuery innerJoinWithTransactions() Adds a INNER JOIN clause and with to the query using the Transactions relation
 *
 * @method     \CartQuery|\MailingaddressQuery|\TransactionsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUsers findOneByPaypalEmail(string $paypal_email) Return the first ChildUsers filtered by the paypal_email column
 * @method     ChildUsers findOneByJoinDate(string $join_date) Return the first ChildUsers filtered by the join_date column *
 ...
 * @method     ChildUsers requireOneByPaypalEmail(string $paypal_email) Return the first ChildUsers filtered by the paypal_email column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUsers requireOneByJoinDate(string $join_date) Return the first ChildUsers filtered by the join_date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsers[]|ObjectCollection findByPaypalEmail(string $paypal_email) Return ChildUsers objects filtered by the paypal_email column
 * @method     ChildUsers[]|ObjectCollection findByJoinDate(string $join_date) Return ChildUsers objects filtered by the join_date column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, first_name, last_name, email, password_hash, paypal_email, join_date FROM Users WHERE id = :p0';
        try {
    ...
    public function filterByPaypalEmail($paypalEmail = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UsersTableMap::COL_PAYPAL_EMAIL, $paypalEmail, $comparison);
    }
    ...
    public function filterByJoinDate($joinDate = null, $comparison = null)
    {
        if (is_array($joinDate)) {
            ...
            if (isset($joinDate['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_JOIN_DATE, $joinDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($joinDate['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_JOIN_DATE, $joinDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_JOIN_DATE, $joinDate, $comparison);
    }
    ...
    public function filterByCart($cart, $comparison = null)
    {
        if ($cart instanceof \Cart) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $cart->getUserId(), $comparison);
     ...
     *
     * @param \Mailingaddress|ObjectCollection $mailingaddress the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUsersQuery The current query, for fluid interface
     */
    public function filterByMailingaddress($mailingaddress, $comparison = null)
    {
        if ($mailingaddress instanceof \Mailingaddress) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $mailingaddress->getUserId(), $comparison);
        } elseif ($mailingaddress instanceof ObjectCollection) {
            return $this
                ->useMailingaddressQuery()
                ->filterByPrimaryKeys($mailingaddress->getPrimaryKeys())
                ->endUse();
        } else {
     ...
     *
     * @param \Transactions|ObjectCollection $transactions the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUsersQuery The current query, for fluid interface
     */
    public function filterByTransactions($transactions, $comparison = null)
    {
        if ($transactions instanceof \Transactions) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $transactions->getUserId(), $comparison);
