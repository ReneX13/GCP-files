...
abstract class Transactions implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TransactionsTableMap';
    ...
    /**
     * The value for the purchase_datetime field.
     *
     * @var        DateTime
     */
    protected $purchase_datetime;
    ...
    /**
     * Initializes internal state of Base\Transactions object.
     */
     ...
     *
     * @return $this|Transactions The current object, for fluid interface
     */
    ...
    /**
     * Get the [optionally formatted] temporal [purchase_datetime] column value.
     *
     *
     ...
     */
    public function getPurchaseDatetime($format = NULL)
    {
        if ($format === null) {
            return $this->purchase_datetime;
        } else {
            return $this->purchase_datetime instanceof \DateTimeInterface ? $this->purchase_datetime->format($format) : null;
        }
    }
     ...
     * @return $this|\Transactions The current object (for fluent API support)
     */
    ...
    public function setConfirmation($v)
    {
        ...
        if ($this->confirmation !== $v) {
            $this->confirmation = $v;
            $this->modifiedColumns[TransactionsTableMap::COL_CONFIRMATION] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[TransactionsTableMap::COL_USER_ID] = true;
        }
    ...
    /**
     * Sets the value of [purchase_datetime] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Transactions The current object (for fluent API support)
     */
    public function setPurchaseDatetime($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->purchase_datetime !== null || $dt !== null) {
            if ($this->purchase_datetime === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->purchase_datetime->format("Y-m-d H:i:s.u")) {
                $this->purchase_datetime = $dt === null ? null : clone $dt;
                $this->modifiedColumns[TransactionsTableMap::COL_PURCHASE_DATETIME] = true;
            }
    ...
    public function setGross($v)
    {
        ...
        if ($this->gross !== $v) {
            $this->gross = $v;
            $this->modifiedColumns[TransactionsTableMap::COL_GROSS] = true;
        }
    ...
    public function setTaxes($v)
    {
        ...
        if ($this->taxes !== $v) {
            $this->taxes = $v;
            $this->modifiedColumns[TransactionsTableMap::COL_TAXES] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TransactionsTableMap::translateFieldName('Confirmation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->confirmation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TransactionsTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TransactionsTableMap::translateFieldName('PurchaseDatetime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->purchase_datetime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TransactionsTableMap::translateFieldName('Gross', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gross = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TransactionsTableMap::translateFieldName('Taxes', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = TransactionsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Transactions'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TransactionsTableMap::COL_CONFIRMATION)) {
            $modifiedColumns[':p' . $index++]  = 'confirmation';
        }
        if ($this->isColumnModified(TransactionsTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(TransactionsTableMap::COL_PURCHASE_DATETIME)) {
            $modifiedColumns[':p' . $index++]  = 'purchase_datetime';
        }
        if ($this->isColumnModified(TransactionsTableMap::COL_GROSS)) {
            $modifiedColumns[':p' . $index++]  = 'Gross';
        }
        if ($this->isColumnModified(TransactionsTableMap::COL_TAXES)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'purchase_datetime':
                        $stmt->bindValue($identifier, $this->purchase_datetime ? $this->purchase_datetime->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'Gross':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getConfirmation(),
            $keys[2] => $this->getUserId(),
            $keys[3] => $this->getPurchaseDatetime(),
            $keys[4] => $this->getGross(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setPurchaseDatetime($value);
                break;
            case 4:
                $this->setGross($value);
                break;
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setConfirmation($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setUserId($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setPurchaseDatetime($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setGross($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setTaxes($arr[$keys[5]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TransactionsTableMap::COL_CONFIRMATION)) {
            $criteria->add(TransactionsTableMap::COL_CONFIRMATION, $this->confirmation);
        }
        if ($this->isColumnModified(TransactionsTableMap::COL_USER_ID)) {
            $criteria->add(TransactionsTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(TransactionsTableMap::COL_PURCHASE_DATETIME)) {
            $criteria->add(TransactionsTableMap::COL_PURCHASE_DATETIME, $this->purchase_datetime);
        }
        if ($this->isColumnModified(TransactionsTableMap::COL_GROSS)) {
            $criteria->add(TransactionsTableMap::COL_GROSS, $this->gross);
        }
        if ($this->isColumnModified(TransactionsTableMap::COL_TAXES)) {
            $criteria->add(TransactionsTableMap::COL_TAXES, $this->taxes);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPurchaseDatetime($this->getPurchaseDatetime());
    ...
    public function getUsers(ConnectionInterface $con = null)
    {
        if ($this->aUsers === null && ($this->user_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUsers->addTransactionss($this);
             */
        }
     ...
     * If this ChildTransactions is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTransactions The current object (for fluent API support)
     */
    public function setProductintransactions(Collection $productintransactions, ConnectionInterface $con = null)
    {
        ...
        foreach ($productintransactionsToDelete as $productintransactionRemoved) {
            $productintransactionRemoved->setTransactions(null);
        }
    ...
    protected function doAddProductintransaction(ChildProductintransaction $productintransaction)
    {
        ...
        $productintransaction->setTransactions($this);
    }
    ...
    public function removeProductintransaction(ChildProductintransaction $productintransaction)
    {
        if ($this->getProductintransactions()->contains($productintransaction)) {
            ...
            $productintransaction->setTransactions(null);
        }
     ...
     * Otherwise if this Transactions is new, it will return
     * an empty collection; or if this Transactions has previously
     * been saved, it will retrieve related Productintransactions from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Transactions.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildProductintransaction[] List of ChildProductintransaction objects
     */
    public function getProductintransactionsJoinProducts(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductintransactionQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aUsers) {
            $this->aUsers->removeTransactions($this);
        }
        $this->id = null;
        $this->confirmation = null;
        $this->user_id = null;
        $this->purchase_datetime = null;
        $this->gross = null;
        $this->taxes = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
