...
abstract class Cart implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CartTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CartTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CartTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CartTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function hashCode()
    {
        ...
        //relation Cart_ibfk_1 to table Users
        ...
        //relation Cart_ibfk_2 to table Products
    ...
    {
        if (null !== $this->aUsers) {
            $this->aUsers->removeCart($this);
        }
        if (null !== $this->aProducts) {
            $this->aProducts->removeCart($this);
        }
        $this->user_id = null;
