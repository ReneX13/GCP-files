 ...
 *
 * @method     ChildCartQuery leftJoinUsers($relationAlias = null) Adds a LEFT JOIN clause to the query using the Users relation
 * @method     ChildCartQuery rightJoinUsers($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Users relation
 * @method     ChildCartQuery innerJoinUsers($relationAlias = null) Adds a INNER JOIN clause to the query using the Users relation
 *
 * @method     ChildCartQuery joinWithUsers($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Users relation
 *
 * @method     ChildCartQuery leftJoinWithUsers() Adds a LEFT JOIN clause and with to the query using the Users relation
 * @method     ChildCartQuery rightJoinWithUsers() Adds a RIGHT JOIN clause and with to the query using the Users relation
 * @method     ChildCartQuery innerJoinWithUsers() Adds a INNER JOIN clause and with to the query using the Users relation
 *
 * @method     ChildCartQuery leftJoinProducts($relationAlias = null) Adds a LEFT JOIN clause to the query using the Products relation
 * @method     ChildCartQuery rightJoinProducts($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Products relation
 * @method     ChildCartQuery innerJoinProducts($relationAlias = null) Adds a INNER JOIN clause to the query using the Products relation
 *
 * @method     ChildCartQuery joinWithProducts($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Products relation
 *
 * @method     ChildCartQuery leftJoinWithProducts() Adds a LEFT JOIN clause and with to the query using the Products relation
 * @method     ChildCartQuery rightJoinWithProducts() Adds a RIGHT JOIN clause and with to the query using the Products relation
 * @method     ChildCartQuery innerJoinWithProducts() Adds a INNER JOIN clause and with to the query using the Products relation
 *
 * @method     \UsersQuery|\ProductsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildCart findOneByAmount(int $amount) Return the first ChildCart filtered by the amount column *
 ...
 * @method     ChildCart requireOneByAmount(int $amount) Return the first ChildCart filtered by the amount column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildCart[]|ObjectCollection findByAmount(int $amount) Return ChildCart objects filtered by the amount column
...
abstract class CartQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT user_id, product_id, amount FROM Cart WHERE user_id = :p0 AND product_id = :p1';
        try {
    ...
    {
        $this->addUsingAlias(CartTableMap::COL_USER_ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(CartTableMap::COL_PRODUCT_ID, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(CartTableMap::COL_USER_ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(CartTableMap::COL_PRODUCT_ID, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterByUsers($users, $comparison = null)
    {
        if ($users instanceof \Users) {
            return $this
                ->addUsingAlias(CartTableMap::COL_USER_ID, $users->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CartTableMap::COL_USER_ID, $users->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByProducts($products, $comparison = null)
    {
        if ($products instanceof \Products) {
            return $this
                ->addUsingAlias(CartTableMap::COL_PRODUCT_ID, $products->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CartTableMap::COL_PRODUCT_ID, $products->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($cart) {
            $this->addCond('pruneCond0', $this->getAliasedColName(CartTableMap::COL_USER_ID), $cart->getUserId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(CartTableMap::COL_PRODUCT_ID), $cart->getProductId(), Criteria::NOT_EQUAL);
