 ...
 *
 * @method     ChildMailingaddressQuery leftJoinTransactions($relationAlias = null) Adds a LEFT JOIN clause to the query using the Transactions relation
 * @method     ChildMailingaddressQuery rightJoinTransactions($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Transactions relation
 * @method     ChildMailingaddressQuery innerJoinTransactions($relationAlias = null) Adds a INNER JOIN clause to the query using the Transactions relation
 *
 * @method     ChildMailingaddressQuery joinWithTransactions($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Transactions relation
 *
 * @method     ChildMailingaddressQuery leftJoinWithTransactions() Adds a LEFT JOIN clause and with to the query using the Transactions relation
 * @method     ChildMailingaddressQuery rightJoinWithTransactions() Adds a RIGHT JOIN clause and with to the query using the Transactions relation
 * @method     ChildMailingaddressQuery innerJoinWithTransactions() Adds a INNER JOIN clause and with to the query using the Transactions relation
 *
 * @method     \UsersQuery|\TransactionsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class MailingaddressQuery extends ModelCriteria
{
    ...
    public function filterByTransactions($transactions, $comparison = null)
    {
        if ($transactions instanceof \Transactions) {
            return $this
                ->addUsingAlias(MailingaddressTableMap::COL_ID, $transactions->getMailingId(), $comparison);
