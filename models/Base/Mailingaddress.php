...
/**
 * Base class that represents a row from the 'MailingAddress' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Mailingaddress implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MailingaddressTableMap';
    ...
    /**
     * Initializes internal state of Base\Mailingaddress object.
     */
    ...
    /**
     * Compares this with another <code>Mailingaddress</code> instance.  If
     * <code>obj</code> is an instance of <code>Mailingaddress</code>, delegates to
     * <code>equals(Mailingaddress)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Mailingaddress The current object, for fluid interface
     */
     ...
     * @return $this|\Mailingaddress The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MailingaddressTableMap::COL_ID] = true;
        }
    ...
    public function setState($v)
    {
        ...
        if ($this->state !== $v) {
            $this->state = $v;
            $this->modifiedColumns[MailingaddressTableMap::COL_STATE] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[MailingaddressTableMap::COL_CITY] = true;
        }
    ...
    public function setZip($v)
    {
        ...
        if ($this->zip !== $v) {
            $this->zip = $v;
            $this->modifiedColumns[MailingaddressTableMap::COL_ZIP] = true;
        }
    ...
    public function setStreet($v)
    {
        ...
        if ($this->street !== $v) {
            $this->street = $v;
            $this->modifiedColumns[MailingaddressTableMap::COL_STREET] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[MailingaddressTableMap::COL_USER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MailingaddressTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MailingaddressTableMap::translateFieldName('State', TableMap::TYPE_PHPNAME, $indexType)];
            $this->state = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MailingaddressTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MailingaddressTableMap::translateFieldName('Zip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zip = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MailingaddressTableMap::translateFieldName('Street', TableMap::TYPE_PHPNAME, $indexType)];
            $this->street = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MailingaddressTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = MailingaddressTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Mailingaddress'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMailingaddressQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Mailingaddress::setDeleted()
     * @see Mailingaddress::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMailingaddressQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MailingaddressTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MailingaddressTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_STATE)) {
            $modifiedColumns[':p' . $index++]  = 'state';
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_CITY)) {
            $modifiedColumns[':p' . $index++]  = 'city';
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_ZIP)) {
            $modifiedColumns[':p' . $index++]  = 'zip';
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_STREET)) {
            $modifiedColumns[':p' . $index++]  = 'street';
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }

        $sql = sprintf(
            'INSERT INTO MailingAddress (%s) VALUES (%s)',
    ...
    {
        $pos = MailingaddressTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Mailingaddress'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Mailingaddress'][$this->hashCode()] = true;
        $keys = MailingaddressTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MailingaddressTableMap::COL_ID)) {
            $criteria->add(MailingaddressTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_STATE)) {
            $criteria->add(MailingaddressTableMap::COL_STATE, $this->state);
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_CITY)) {
            $criteria->add(MailingaddressTableMap::COL_CITY, $this->city);
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_ZIP)) {
            $criteria->add(MailingaddressTableMap::COL_ZIP, $this->zip);
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_STREET)) {
            $criteria->add(MailingaddressTableMap::COL_STREET, $this->street);
        }
        if ($this->isColumnModified(MailingaddressTableMap::COL_USER_ID)) {
            $criteria->add(MailingaddressTableMap::COL_USER_ID, $this->user_id);
        }
    ...
    {
        $criteria = ChildMailingaddressQuery::create();
        $criteria->add(MailingaddressTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Mailingaddress (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Mailingaddress Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUsers(ConnectionInterface $con = null)
    {
        if ($this->aUsers === null && ($this->user_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUsers->addMailingaddresses($this);
             */
        }
     ...
     * If this ChildMailingaddress is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMailingaddress The current object (for fluent API support)
     */
    public function setTransactionss(Collection $transactionss, ConnectionInterface $con = null)
    {
        ...
        foreach ($transactionssToDelete as $transactionsRemoved) {
            $transactionsRemoved->setMailingaddress(null);
        }
    ...
    protected function doAddTransactions(ChildTransactions $transactions)
    {
        ...
        $transactions->setMailingaddress($this);
    }
    ...
    public function removeTransactions(ChildTransactions $transactions)
    {
        if ($this->getTransactionss()->contains($transactions)) {
            ...
            $transactions->setMailingaddress(null);
        }
     ...
     * Otherwise if this Mailingaddress is new, it will return
     * an empty collection; or if this Mailingaddress has previously
     * been saved, it will retrieve related Transactionss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Mailingaddress.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTransactions[] List of ChildTransactions objects
     */
    public function getTransactionssJoinUsers(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTransactionsQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aUsers) {
            $this->aUsers->removeMailingaddress($this);
        }
        $this->id = null;
        $this->state = null;
        $this->city = null;
    ...
    {
        return (string) $this->exportTo(MailingaddressTableMap::DEFAULT_STRING_FORMAT);
    }
