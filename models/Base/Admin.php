...
abstract class Admin implements ActiveRecordInterface
{
    ...
    public function setPasswordHash($v)
    {
        ...
        if ($this->password_hash !== $v) {
            ...
            $this->modifiedColumns[AdminTableMap::COL_PASSWORD_HASH] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AdminTableMap::translateFieldName('PasswordHash', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_PASSWORD_HASH)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_PASSWORD_HASH)) {
            $criteria->add(AdminTableMap::COL_PASSWORD_HASH, $this->password_hash);
        }
