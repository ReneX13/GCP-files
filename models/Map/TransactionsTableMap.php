...
class TransactionsTableMap extends TableMap
{
    ...
    /**
     * the column name for the reciept field
     */
    const COL_RECIEPT = 'Transactions.reciept';
     ...
     */
    const COL_MAILING_ID = 'Transactions.mailing_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Reciept', 'UserId', 'MailingId', ),
        self::TYPE_CAMELNAME     => array('id', 'reciept', 'userId', 'mailingId', ),
        self::TYPE_COLNAME       => array(TransactionsTableMap::COL_ID, TransactionsTableMap::COL_RECIEPT, TransactionsTableMap::COL_USER_ID, TransactionsTableMap::COL_MAILING_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'reciept', 'user_id', 'mailing_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Reciept' => 1, 'UserId' => 2, 'MailingId' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'reciept' => 1, 'userId' => 2, 'mailingId' => 3, ),
        self::TYPE_COLNAME       => array(TransactionsTableMap::COL_ID => 0, TransactionsTableMap::COL_RECIEPT => 1, TransactionsTableMap::COL_USER_ID => 2, TransactionsTableMap::COL_MAILING_ID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'reciept' => 1, 'user_id' => 2, 'mailing_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('reciept', 'Reciept', 'LONGVARCHAR', true, null, null);
        $this->addForeignKey('user_id', 'UserId', 'INTEGER', 'Users', 'id', true, 12, null);
        $this->addForeignKey('mailing_id', 'MailingId', 'INTEGER', 'MailingAddress', 'id', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Mailingaddress', '\\Mailingaddress', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':mailing_id',
    1 => ':id',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TransactionsTableMap::COL_RECIEPT);
            $criteria->addSelectColumn(TransactionsTableMap::COL_USER_ID);
            $criteria->addSelectColumn(TransactionsTableMap::COL_MAILING_ID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.reciept');
